...
export const projectsRouter = t.router({
  ...
  findFirstProjectOrThrow: publicProcedure
    .input(ProjectFindFirstSchema).query(async ({ ctx, input }) => {
      const findFirstProjectOrThrow = await ctx.prisma.project.findFirstOrThrow(input);
      return findFirstProjectOrThrow;
    }),
  findManyProject: publicProcedure
    .input(ProjectFindManySchema).query(async ({ ctx, input }) => {
      const findManyProject = await ctx.prisma.project.findMany(input);
      return findManyProject;
    }),
  findUniqueProject: publicProcedure
    .input(ProjectFindUniqueSchema).query(async ({ ctx, input }) => {
  ...
  findUniqueProjectOrThrow: publicProcedure
    .input(ProjectFindUniqueSchema).query(async ({ ctx, input }) => {
      const findUniqueProjectOrThrow = await ctx.prisma.project.findUniqueOrThrow(input);
      return findUniqueProjectOrThrow;
    }),
  groupByProject: publicProcedure
    .input(ProjectGroupBySchema).query(async ({ ctx, input }) => {
  ...
  updateManyProject: publicProcedure
    .input(ProjectUpdateManySchema).mutation(async ({ ctx, input }) => {
