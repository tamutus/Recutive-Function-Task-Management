...
export const TaskTemplateCreateWithoutPrivateEnergiesInputSchema: z.ZodType<Prisma.TaskTemplateCreateWithoutPrivateEnergiesInput> = z.object({
  name: z.string(),
...
export default TaskTemplateCreateWithoutPrivateEnergiesInputSchema;
