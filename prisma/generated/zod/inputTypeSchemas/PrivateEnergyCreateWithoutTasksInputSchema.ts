...
export const PrivateEnergyCreateWithoutTasksInputSchema: z.ZodType<Prisma.PrivateEnergyCreateWithoutTasksInput> = z.object({
  name: z.string(),
  unit: z.string(),
...
export default PrivateEnergyCreateWithoutTasksInputSchema;
