...
export const TaskCreateWithoutPrivateEnergiesInputSchema: z.ZodType<Prisma.TaskCreateWithoutPrivateEnergiesInput> = z.object({
  name: z.string(),
...
export default TaskCreateWithoutPrivateEnergiesInputSchema;
