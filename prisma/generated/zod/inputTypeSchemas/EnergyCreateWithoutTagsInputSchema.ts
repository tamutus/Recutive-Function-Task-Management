...
export const EnergyCreateWithoutTagsInputSchema: z.ZodType<Prisma.EnergyCreateWithoutTagsInput> = z.object({
  name: z.string(),
  unit: z.string(),
...
export default EnergyCreateWithoutTagsInputSchema;
