...
export const PersonCreateWithoutEditedTasksInputSchema: z.ZodType<Prisma.PersonCreateWithoutEditedTasksInput> = z.object({
...
export default PersonCreateWithoutEditedTasksInputSchema;
