...
export const TaskCreateWithoutSuccessorsInputSchema: z.ZodType<Prisma.TaskCreateWithoutSuccessorsInput> = z.object({
  name: z.string(),
...
export default TaskCreateWithoutSuccessorsInputSchema;
