...
export const TaskTemplateCreateWithoutPrecursorsInputSchema: z.ZodType<Prisma.TaskTemplateCreateWithoutPrecursorsInput> = z.object({
  name: z.string(),
...
export default TaskTemplateCreateWithoutPrecursorsInputSchema;
