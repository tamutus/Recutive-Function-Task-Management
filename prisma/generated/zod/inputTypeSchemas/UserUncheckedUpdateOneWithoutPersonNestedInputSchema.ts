...
export const UserUncheckedUpdateOneWithoutPersonNestedInputSchema: z.ZodType<Prisma.UserUncheckedUpdateOneWithoutPersonNestedInput> = z.object({
...
export default UserUncheckedUpdateOneWithoutPersonNestedInputSchema;
