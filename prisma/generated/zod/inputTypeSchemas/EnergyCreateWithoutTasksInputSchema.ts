...
export const EnergyCreateWithoutTasksInputSchema: z.ZodType<Prisma.EnergyCreateWithoutTasksInput> = z.object({
  name: z.string(),
  unit: z.string(),
...
export default EnergyCreateWithoutTasksInputSchema;
