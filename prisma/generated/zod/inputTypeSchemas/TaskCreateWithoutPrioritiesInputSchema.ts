...
export const TaskCreateWithoutPrioritiesInputSchema: z.ZodType<Prisma.TaskCreateWithoutPrioritiesInput> = z.object({
  name: z.string(),
...
export default TaskCreateWithoutPrioritiesInputSchema;
