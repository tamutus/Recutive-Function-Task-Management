...
export const EnergyCreateWithoutPrivateTagsInputSchema: z.ZodType<Prisma.EnergyCreateWithoutPrivateTagsInput> = z.object({
  name: z.string(),
  unit: z.string(),
...
export default EnergyCreateWithoutPrivateTagsInputSchema;
