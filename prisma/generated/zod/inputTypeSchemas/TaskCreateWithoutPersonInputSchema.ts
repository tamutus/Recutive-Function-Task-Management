...
export const TaskCreateWithoutPersonInputSchema: z.ZodType<Prisma.TaskCreateWithoutPersonInput> = z.object({
  name: z.string(),
...
export default TaskCreateWithoutPersonInputSchema;
