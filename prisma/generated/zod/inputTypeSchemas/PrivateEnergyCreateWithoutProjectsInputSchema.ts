...
export const PrivateEnergyCreateWithoutProjectsInputSchema: z.ZodType<Prisma.PrivateEnergyCreateWithoutProjectsInput> = z.object({
  name: z.string(),
  unit: z.string(),
...
export default PrivateEnergyCreateWithoutProjectsInputSchema;
