...
export const TaskTemplateCreateWithoutSuccessorsInputSchema: z.ZodType<Prisma.TaskTemplateCreateWithoutSuccessorsInput> = z.object({
  name: z.string(),
...
export default TaskTemplateCreateWithoutSuccessorsInputSchema;
