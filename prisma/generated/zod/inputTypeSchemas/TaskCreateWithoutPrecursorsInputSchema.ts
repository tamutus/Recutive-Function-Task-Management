...
export const TaskCreateWithoutPrecursorsInputSchema: z.ZodType<Prisma.TaskCreateWithoutPrecursorsInput> = z.object({
  name: z.string(),
...
export default TaskCreateWithoutPrecursorsInputSchema;
