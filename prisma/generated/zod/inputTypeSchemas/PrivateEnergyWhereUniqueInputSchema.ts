...
export const PrivateEnergyWhereUniqueInputSchema: z.ZodType<Prisma.PrivateEnergyWhereUniqueInput> = z.object({
  id: z.number()
})
.and(z.object({
...
export default PrivateEnergyWhereUniqueInputSchema;
