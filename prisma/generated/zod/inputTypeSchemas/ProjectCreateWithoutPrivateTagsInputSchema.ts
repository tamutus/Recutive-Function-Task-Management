...
export const ProjectCreateWithoutPrivateTagsInputSchema: z.ZodType<Prisma.ProjectCreateWithoutPrivateTagsInput> = z.object({
  name: z.string(),
...
export default ProjectCreateWithoutPrivateTagsInputSchema;
