...
export const PrivateEnergyCreateWithoutPrivateTagsInputSchema: z.ZodType<Prisma.PrivateEnergyCreateWithoutPrivateTagsInput> = z.object({
  name: z.string(),
  unit: z.string(),
...
export default PrivateEnergyCreateWithoutPrivateTagsInputSchema;
