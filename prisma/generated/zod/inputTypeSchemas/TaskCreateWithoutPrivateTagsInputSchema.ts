...
export const TaskCreateWithoutPrivateTagsInputSchema: z.ZodType<Prisma.TaskCreateWithoutPrivateTagsInput> = z.object({
  name: z.string(),
...
export default TaskCreateWithoutPrivateTagsInputSchema;
