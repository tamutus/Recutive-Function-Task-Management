...
export const EnergyCreateWithoutTaskTemplatesInputSchema: z.ZodType<Prisma.EnergyCreateWithoutTaskTemplatesInput> = z.object({
  name: z.string(),
  unit: z.string(),
...
export default EnergyCreateWithoutTaskTemplatesInputSchema;
