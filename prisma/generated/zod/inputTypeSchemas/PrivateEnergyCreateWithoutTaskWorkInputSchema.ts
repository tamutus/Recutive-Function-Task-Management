...
export const PrivateEnergyCreateWithoutTaskWorkInputSchema: z.ZodType<Prisma.PrivateEnergyCreateWithoutTaskWorkInput> = z.object({
  name: z.string(),
  unit: z.string(),
...
export default PrivateEnergyCreateWithoutTaskWorkInputSchema;
