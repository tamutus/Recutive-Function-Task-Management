...
export const EnergyCreateWithoutProjectTemplatesInputSchema: z.ZodType<Prisma.EnergyCreateWithoutProjectTemplatesInput> = z.object({
  name: z.string(),
  unit: z.string(),
...
export default EnergyCreateWithoutProjectTemplatesInputSchema;
