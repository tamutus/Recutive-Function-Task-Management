...
export const TagsToTaskTemplatesCreateNestedManyWithoutTaggerInputSchema: z.ZodType<Prisma.TagsToTaskTemplatesCreateNestedManyWithoutTaggerInput> = z.object({
...
export default TagsToTaskTemplatesCreateNestedManyWithoutTaggerInputSchema;
