...
export const PersonUncheckedCreateWithoutUserInputSchema: z.ZodType<Prisma.PersonUncheckedCreateWithoutUserInput> = z.object({
...
export default PersonUncheckedCreateWithoutUserInputSchema;
