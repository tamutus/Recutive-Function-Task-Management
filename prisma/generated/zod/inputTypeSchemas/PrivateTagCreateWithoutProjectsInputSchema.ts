...
export const PrivateTagCreateWithoutProjectsInputSchema: z.ZodType<Prisma.PrivateTagCreateWithoutProjectsInput> = z.object({
  name: z.string(),
...
export default PrivateTagCreateWithoutProjectsInputSchema;
