...
export const EnergyCreateWithoutExperiencesInputSchema: z.ZodType<Prisma.EnergyCreateWithoutExperiencesInput> = z.object({
  name: z.string(),
  unit: z.string(),
...
export default EnergyCreateWithoutExperiencesInputSchema;
