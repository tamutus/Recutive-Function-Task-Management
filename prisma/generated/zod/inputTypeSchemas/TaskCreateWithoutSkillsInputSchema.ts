...
export const TaskCreateWithoutSkillsInputSchema: z.ZodType<Prisma.TaskCreateWithoutSkillsInput> = z.object({
  name: z.string(),
...
export default TaskCreateWithoutSkillsInputSchema;
