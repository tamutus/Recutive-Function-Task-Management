...
export const TaskTemplateCreateWithoutImplementationsInputSchema: z.ZodType<Prisma.TaskTemplateCreateWithoutImplementationsInput> = z.object({
  name: z.string(),
...
export default TaskTemplateCreateWithoutImplementationsInputSchema;
