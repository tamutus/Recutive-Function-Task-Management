...
export const TaskTemplateCreateWithoutProjectsInputSchema: z.ZodType<Prisma.TaskTemplateCreateWithoutProjectsInput> = z.object({
  name: z.string(),
...
export default TaskTemplateCreateWithoutProjectsInputSchema;
