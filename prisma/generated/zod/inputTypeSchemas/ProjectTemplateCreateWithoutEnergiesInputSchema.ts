...
export const ProjectTemplateCreateWithoutEnergiesInputSchema: z.ZodType<Prisma.ProjectTemplateCreateWithoutEnergiesInput> = z.object({
  name: z.string(),
...
export default ProjectTemplateCreateWithoutEnergiesInputSchema;
