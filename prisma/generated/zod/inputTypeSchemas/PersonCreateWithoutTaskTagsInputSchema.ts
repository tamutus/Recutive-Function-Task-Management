...
export const PersonCreateWithoutTaskTagsInputSchema: z.ZodType<Prisma.PersonCreateWithoutTaskTagsInput> = z.object({
...
export default PersonCreateWithoutTaskTagsInputSchema;
