...
export const TaskTemplateCreateWithoutTagsInputSchema: z.ZodType<Prisma.TaskTemplateCreateWithoutTagsInput> = z.object({
  name: z.string(),
...
export default TaskTemplateCreateWithoutTagsInputSchema;
