...
export const EnergyCreateWithoutProjectsInputSchema: z.ZodType<Prisma.EnergyCreateWithoutProjectsInput> = z.object({
  name: z.string(),
  unit: z.string(),
...
export default EnergyCreateWithoutProjectsInputSchema;
