...
export const EnergyCreateWithoutSkillsInputSchema: z.ZodType<Prisma.EnergyCreateWithoutSkillsInput> = z.object({
  name: z.string(),
  unit: z.string(),
...
export default EnergyCreateWithoutSkillsInputSchema;
