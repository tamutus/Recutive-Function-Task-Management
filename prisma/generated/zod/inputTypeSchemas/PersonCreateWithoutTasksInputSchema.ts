...
export const PersonCreateWithoutTasksInputSchema: z.ZodType<Prisma.PersonCreateWithoutTasksInput> = z.object({
...
export default PersonCreateWithoutTasksInputSchema;
