...
export const EnergyUpdateArgsSchema: z.ZodType<Prisma.EnergyUpdateArgs> = z.object({
  select: EnergySelectSchema.optional(),
  include: EnergyIncludeSchema.optional(),
  data: z.union([ EnergyUpdateInputSchema,EnergyUncheckedUpdateInputSchema ]),
  where: EnergyWhereUniqueInputSchema,
}).strict()

export default EnergyUpdateArgsSchema;
