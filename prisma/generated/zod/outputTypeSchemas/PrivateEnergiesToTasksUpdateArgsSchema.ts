...
export const PrivateEnergiesToTasksUpdateArgsSchema: z.ZodType<Prisma.PrivateEnergiesToTasksUpdateArgs> = z.object({
  select: PrivateEnergiesToTasksSelectSchema.optional(),
  include: PrivateEnergiesToTasksIncludeSchema.optional(),
  data: z.union([ PrivateEnergiesToTasksUpdateInputSchema,PrivateEnergiesToTasksUncheckedUpdateInputSchema ]),
  where: PrivateEnergiesToTasksWhereUniqueInputSchema,
}).strict()

export default PrivateEnergiesToTasksUpdateArgsSchema;
