...
export const EnergiesToTagsUpdateArgsSchema: z.ZodType<Prisma.EnergiesToTagsUpdateArgs> = z.object({
  select: EnergiesToTagsSelectSchema.optional(),
  include: EnergiesToTagsIncludeSchema.optional(),
  data: z.union([ EnergiesToTagsUpdateInputSchema,EnergiesToTagsUncheckedUpdateInputSchema ]),
  where: EnergiesToTagsWhereUniqueInputSchema,
}).strict()

export default EnergiesToTagsUpdateArgsSchema;
