...
export const TaskWorkFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.TaskWorkFindUniqueOrThrowArgs> = z.object({
  select: TaskWorkSelectSchema.optional(),
  include: TaskWorkIncludeSchema.optional(),
  where: TaskWorkWhereUniqueInputSchema,
}).strict()

export default TaskWorkFindUniqueOrThrowArgsSchema;
