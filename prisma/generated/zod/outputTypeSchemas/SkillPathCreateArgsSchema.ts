...
export const SkillPathCreateArgsSchema: z.ZodType<Prisma.SkillPathCreateArgs> = z.object({
  select: SkillPathSelectSchema.optional(),
  include: SkillPathIncludeSchema.optional(),
  data: z.union([ SkillPathCreateInputSchema,SkillPathUncheckedCreateInputSchema ]),
}).strict()

export default SkillPathCreateArgsSchema;
