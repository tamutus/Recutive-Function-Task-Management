...
export const EnergyCreateArgsSchema: z.ZodType<Prisma.EnergyCreateArgs> = z.object({
  select: EnergySelectSchema.optional(),
  include: EnergyIncludeSchema.optional(),
  data: z.union([ EnergyCreateInputSchema,EnergyUncheckedCreateInputSchema ]),
}).strict()

export default EnergyCreateArgsSchema;
