...
export const SkillLinkUpdateArgsSchema: z.ZodType<Prisma.SkillLinkUpdateArgs> = z.object({
  select: SkillLinkSelectSchema.optional(),
  include: SkillLinkIncludeSchema.optional(),
  data: z.union([ SkillLinkUpdateInputSchema,SkillLinkUncheckedUpdateInputSchema ]),
  where: SkillLinkWhereUniqueInputSchema,
}).strict()

export default SkillLinkUpdateArgsSchema;
