...
export const PersonsToSkillsCreateArgsSchema: z.ZodType<Prisma.PersonsToSkillsCreateArgs> = z.object({
  select: PersonsToSkillsSelectSchema.optional(),
  include: PersonsToSkillsIncludeSchema.optional(),
  data: z.union([ PersonsToSkillsCreateInputSchema,PersonsToSkillsUncheckedCreateInputSchema ]),
}).strict()

export default PersonsToSkillsCreateArgsSchema;
