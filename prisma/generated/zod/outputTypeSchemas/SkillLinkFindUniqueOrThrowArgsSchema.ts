...
export const SkillLinkFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.SkillLinkFindUniqueOrThrowArgs> = z.object({
  select: SkillLinkSelectSchema.optional(),
  include: SkillLinkIncludeSchema.optional(),
  where: SkillLinkWhereUniqueInputSchema,
}).strict()

export default SkillLinkFindUniqueOrThrowArgsSchema;
