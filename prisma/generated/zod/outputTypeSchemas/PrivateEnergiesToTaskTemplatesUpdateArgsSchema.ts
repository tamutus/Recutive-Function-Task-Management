...
export const PrivateEnergiesToTaskTemplatesUpdateArgsSchema: z.ZodType<Prisma.PrivateEnergiesToTaskTemplatesUpdateArgs> = z.object({
  select: PrivateEnergiesToTaskTemplatesSelectSchema.optional(),
  include: PrivateEnergiesToTaskTemplatesIncludeSchema.optional(),
  data: z.union([ PrivateEnergiesToTaskTemplatesUpdateInputSchema,PrivateEnergiesToTaskTemplatesUncheckedUpdateInputSchema ]),
  where: PrivateEnergiesToTaskTemplatesWhereUniqueInputSchema,
}).strict()

export default PrivateEnergiesToTaskTemplatesUpdateArgsSchema;
