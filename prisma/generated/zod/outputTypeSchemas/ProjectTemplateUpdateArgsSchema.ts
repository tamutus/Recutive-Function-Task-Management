...
export const ProjectTemplateUpdateArgsSchema: z.ZodType<Prisma.ProjectTemplateUpdateArgs> = z.object({
  select: ProjectTemplateSelectSchema.optional(),
  include: ProjectTemplateIncludeSchema.optional(),
  data: z.union([ ProjectTemplateUpdateInputSchema,ProjectTemplateUncheckedUpdateInputSchema ]),
  where: ProjectTemplateWhereUniqueInputSchema,
}).strict()

export default ProjectTemplateUpdateArgsSchema;
