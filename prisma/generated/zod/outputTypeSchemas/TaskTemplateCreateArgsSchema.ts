...
export const TaskTemplateCreateArgsSchema: z.ZodType<Prisma.TaskTemplateCreateArgs> = z.object({
  select: TaskTemplateSelectSchema.optional(),
  include: TaskTemplateIncludeSchema.optional(),
  data: z.union([ TaskTemplateCreateInputSchema,TaskTemplateUncheckedCreateInputSchema ]),
}).strict()

export default TaskTemplateCreateArgsSchema;
