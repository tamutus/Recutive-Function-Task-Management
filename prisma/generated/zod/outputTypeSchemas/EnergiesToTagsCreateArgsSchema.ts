...
export const EnergiesToTagsCreateArgsSchema: z.ZodType<Prisma.EnergiesToTagsCreateArgs> = z.object({
  select: EnergiesToTagsSelectSchema.optional(),
  include: EnergiesToTagsIncludeSchema.optional(),
  data: z.union([ EnergiesToTagsCreateInputSchema,EnergiesToTagsUncheckedCreateInputSchema ]),
}).strict()

export default EnergiesToTagsCreateArgsSchema;
