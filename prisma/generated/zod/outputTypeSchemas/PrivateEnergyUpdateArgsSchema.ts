...
export const PrivateEnergyUpdateArgsSchema: z.ZodType<Prisma.PrivateEnergyUpdateArgs> = z.object({
  select: PrivateEnergySelectSchema.optional(),
  include: PrivateEnergyIncludeSchema.optional(),
  data: z.union([ PrivateEnergyUpdateInputSchema,PrivateEnergyUncheckedUpdateInputSchema ]),
  where: PrivateEnergyWhereUniqueInputSchema,
}).strict()

export default PrivateEnergyUpdateArgsSchema;
