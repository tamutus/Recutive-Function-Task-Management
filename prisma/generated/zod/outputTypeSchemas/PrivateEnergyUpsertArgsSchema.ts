...
import { PrivateEnergyUpdateInputSchema } from '../inputTypeSchemas/PrivateEnergyUpdateInputSchema'
import { PrivateEnergyUncheckedUpdateInputSchema } from '../inputTypeSchemas/PrivateEnergyUncheckedUpdateInputSchema'
...
export const PrivateEnergyUpsertArgsSchema: z.ZodType<Prisma.PrivateEnergyUpsertArgs> = z.object({
  select: PrivateEnergySelectSchema.optional(),
  include: PrivateEnergyIncludeSchema.optional(),
  where: PrivateEnergyWhereUniqueInputSchema,
  create: z.union([ PrivateEnergyCreateInputSchema,PrivateEnergyUncheckedCreateInputSchema ]),
  update: z.union([ PrivateEnergyUpdateInputSchema,PrivateEnergyUncheckedUpdateInputSchema ]),
}).strict()

export default PrivateEnergyUpsertArgsSchema;
