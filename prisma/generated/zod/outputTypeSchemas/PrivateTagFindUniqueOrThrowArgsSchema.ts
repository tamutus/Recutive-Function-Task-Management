...
export const PrivateTagFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.PrivateTagFindUniqueOrThrowArgs> = z.object({
  select: PrivateTagSelectSchema.optional(),
  include: PrivateTagIncludeSchema.optional(),
  where: PrivateTagWhereUniqueInputSchema,
}).strict()

export default PrivateTagFindUniqueOrThrowArgsSchema;
