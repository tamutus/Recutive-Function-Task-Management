...
export const PrivateTagCreateArgsSchema: z.ZodType<Prisma.PrivateTagCreateArgs> = z.object({
  select: PrivateTagSelectSchema.optional(),
  include: PrivateTagIncludeSchema.optional(),
  data: z.union([ PrivateTagCreateInputSchema,PrivateTagUncheckedCreateInputSchema ]),
}).strict()

export default PrivateTagCreateArgsSchema;
