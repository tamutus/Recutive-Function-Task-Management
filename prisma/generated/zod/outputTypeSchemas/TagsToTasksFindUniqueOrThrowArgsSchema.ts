...
export const TagsToTasksFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.TagsToTasksFindUniqueOrThrowArgs> = z.object({
  select: TagsToTasksSelectSchema.optional(),
  include: TagsToTasksIncludeSchema.optional(),
  where: TagsToTasksWhereUniqueInputSchema,
}).strict()

export default TagsToTasksFindUniqueOrThrowArgsSchema;
