...
import { EnergyCreateInputSchema } from '../inputTypeSchemas/EnergyCreateInputSchema'
import { EnergyUncheckedCreateInputSchema } from '../inputTypeSchemas/EnergyUncheckedCreateInputSchema'
import { EnergyUpdateInputSchema } from '../inputTypeSchemas/EnergyUpdateInputSchema'
import { EnergyUncheckedUpdateInputSchema } from '../inputTypeSchemas/EnergyUncheckedUpdateInputSchema'
...
export const EnergyUpsertArgsSchema: z.ZodType<Prisma.EnergyUpsertArgs> = z.object({
  select: EnergySelectSchema.optional(),
  include: EnergyIncludeSchema.optional(),
  where: EnergyWhereUniqueInputSchema,
  create: z.union([ EnergyCreateInputSchema,EnergyUncheckedCreateInputSchema ]),
  update: z.union([ EnergyUpdateInputSchema,EnergyUncheckedUpdateInputSchema ]),
}).strict()

export default EnergyUpsertArgsSchema;
