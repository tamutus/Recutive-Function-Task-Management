...
export const SkillPathFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.SkillPathFindUniqueOrThrowArgs> = z.object({
  select: SkillPathSelectSchema.optional(),
  include: SkillPathIncludeSchema.optional(),
  where: SkillPathWhereUniqueInputSchema,
}).strict()

export default SkillPathFindUniqueOrThrowArgsSchema;
