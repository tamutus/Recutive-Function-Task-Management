...
export const EnergiesToTaskTemplatesUpsertArgsSchema: z.ZodType<Prisma.EnergiesToTaskTemplatesUpsertArgs> = z.object({
  ...
  create: z.union([ EnergiesToTaskTemplatesCreateInputSchema,EnergiesToTaskTemplatesUncheckedCreateInputSchema ]),
  update: z.union([ EnergiesToTaskTemplatesUpdateInputSchema,EnergiesToTaskTemplatesUncheckedUpdateInputSchema ]),
}).strict()

export default EnergiesToTaskTemplatesUpsertArgsSchema;
