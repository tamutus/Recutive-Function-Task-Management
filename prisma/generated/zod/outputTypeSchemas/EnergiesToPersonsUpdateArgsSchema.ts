...
export const EnergiesToPersonsUpdateArgsSchema: z.ZodType<Prisma.EnergiesToPersonsUpdateArgs> = z.object({
  select: EnergiesToPersonsSelectSchema.optional(),
  include: EnergiesToPersonsIncludeSchema.optional(),
  data: z.union([ EnergiesToPersonsUpdateInputSchema,EnergiesToPersonsUncheckedUpdateInputSchema ]),
  where: EnergiesToPersonsWhereUniqueInputSchema,
}).strict()

export default EnergiesToPersonsUpdateArgsSchema;
