...
export const ProjectTemplateCreateArgsSchema: z.ZodType<Prisma.ProjectTemplateCreateArgs> = z.object({
  select: ProjectTemplateSelectSchema.optional(),
  include: ProjectTemplateIncludeSchema.optional(),
  data: z.union([ ProjectTemplateCreateInputSchema,ProjectTemplateUncheckedCreateInputSchema ]),
}).strict()

export default ProjectTemplateCreateArgsSchema;
