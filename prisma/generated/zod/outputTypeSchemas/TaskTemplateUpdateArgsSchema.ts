...
export const TaskTemplateUpdateArgsSchema: z.ZodType<Prisma.TaskTemplateUpdateArgs> = z.object({
  select: TaskTemplateSelectSchema.optional(),
  include: TaskTemplateIncludeSchema.optional(),
  data: z.union([ TaskTemplateUpdateInputSchema,TaskTemplateUncheckedUpdateInputSchema ]),
  where: TaskTemplateWhereUniqueInputSchema,
}).strict()

export default TaskTemplateUpdateArgsSchema;
