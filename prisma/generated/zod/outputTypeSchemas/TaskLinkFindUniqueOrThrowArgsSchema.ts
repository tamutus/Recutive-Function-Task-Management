...
export const TaskLinkFindUniqueOrThrowArgsSchema: z.ZodType<Prisma.TaskLinkFindUniqueOrThrowArgs> = z.object({
  select: TaskLinkSelectSchema.optional(),
  include: TaskLinkIncludeSchema.optional(),
  where: TaskLinkWhereUniqueInputSchema,
}).strict()

export default TaskLinkFindUniqueOrThrowArgsSchema;
