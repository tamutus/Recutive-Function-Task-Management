...
export const PrivateTagUpdateArgsSchema: z.ZodType<Prisma.PrivateTagUpdateArgs> = z.object({
  select: PrivateTagSelectSchema.optional(),
  include: PrivateTagIncludeSchema.optional(),
  data: z.union([ PrivateTagUpdateInputSchema,PrivateTagUncheckedUpdateInputSchema ]),
  where: PrivateTagWhereUniqueInputSchema,
}).strict()

export default PrivateTagUpdateArgsSchema;
